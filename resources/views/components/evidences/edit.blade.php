...
<div class="col-md-12 col-sm-12 col-xs-12">
    @include('components.alerts.all')
            <div class="x_panel">
                  <div class="x_title">
                    <h2>Editar Evidencia<small></small></h2>
                  ...
                  <div class="row">
                    <div class="col-md-8">
                      <div class="img-container">
                        <img id="image" src="{{ route('evidence',$item->ubicacion) }}" alt="Picture">
                      </div>
                    </div>
                    <div class="col-md-4">
                      ...
                      <div class="docs-preview clearfix">
                          ...
                          <form action="{{ route('evidencias.update',$item->id) }}" method="POST" enctype="multipart/form-data">
                              @csrf
                              <input type="hidden" name="notificacion" value="{{$item->notificacion}}">
                             {{method_field('PATCH')}}
          ...
          <a href="{{route('evidencias.index',['notificacion'=>$item->notificacion]) }}" class="btn btn-dark"> <i class="fa fa-arrow-left"></i> Regresar</a>
      </div>
    </div>         
</div>
@endsection