...
<div class="x_panel">
    <div class="x_title">
      <h2>Nueva Dirección <small></small></h2>
    ...
    <div class="x_content">
      ...
      <form action="{{ route('calles-localidad.store') }}" method="POST" id="demo-form2"  class="form-horizontal form-label-left">
      @csrf
        <div class="form-group">
        <input type="hidden" name="localidad" value="{{ $location }}" autocomplete="off">
        <input type="hidden" name="municipio" value="{{ $municipalitie }}" autocomplete="off">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Nombre <span class="required">*</span>
          </label>
          <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12 @error('nombre') parsley-error @enderror " name="nombre" value="{{ old('nombre') }}" autocomplete="off">
              @error('nombre')
          ...
          <div id="map" style="width:100%;height:300px" >
           ...
           <div class="form-group">
             <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
               <a href="{{ route('calles-localidad.index',['municipio'=>$municipalitie ,'localidad' => $location] ) }}" class="btn btn-dark"> <i class="fa fa-arrow-left"></i> Cancelar</a>
