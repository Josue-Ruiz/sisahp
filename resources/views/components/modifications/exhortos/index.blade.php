...
@push('extra_js')
    ...
    <script src="{{ asset('js/modification_exhortos.js') }}"></script>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    @include('components.alerts.all')
            <div class="x_panel">
                  <div class="x_title">
                    <h2>Modificaciones | Exhortos <small></small></h2>
                ...
                <div class="well" style="overflow: auto">
                    <form class="form-horizontal" method="GET" action="{{ route('modificacion-exhortos.index') }}">
                          <div class="col-md-4">
                  ...
                  <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        @foreach($registers as $key=>$item)
                            ...
                            @include('components.alerts.confirm',['ruta'=>route('modificacion-exhortos.destroy',$item->id),'id'=>$item->id])
                        @endforeach
